...
puzzleSolver: $(OBJ_DIR)/main.o $(OBJ_DIR)/piece.o $(OBJ_DIR)/pieceDefns.o $(OBJ_DIR)/puzzleDisplay.o 
	$(CXX) $(CXXFLAGS) -o puzzleSolver $(OBJ_DIR)/main.o $(OBJ_DIR)/piece.o $(OBJ_DIR)/pieceDefns.o $(OBJ_DIR)/puzzleDisplay.o 

$(OBJ_DIR)/main.o: src/main.cpp include/puzzleDisplay.hpp include/piece.hpp include/pieceDefns.hpp include/global.hpp | $(OBJ_DIR)
